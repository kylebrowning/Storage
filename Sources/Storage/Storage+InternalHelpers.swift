...
extension Storage {
    ...
    internal static func getValidFilePath(from originalString: String) throws -> String {
        ...
        guard validFileName.count > 0  && validFileName != "." else {
            throw createError(
                ...
                failureReason: "Cannot write/read a file with the name \(originalString) on storage.",
    ...
    internal static func setIsExcludedFromBackup(to isExcludedFromBackup: Bool, for path: String?, in directory: Directory) throws {
        do {
